...
- [Pi Session Manager](https://github.com/Dwsy/pi-session-manager) — Tauri2 desktop app for browsing, searching, and managing Pi Agent sessions with analytics dashboard and 2-layer cache
