...
- [pi-notify-terminal-notifier](https://github.com/Waraq-Labs/pi-notify-terminal-notifier) — Native macOS notifications via terminal-notifier when pi is waiting for input
