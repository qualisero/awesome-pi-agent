...
- [pi-event-monitor](https://github.com/Helmi/pi-event-monitor) — Background event monitors that watch shell output or file system changes and wake the session only when something happens
