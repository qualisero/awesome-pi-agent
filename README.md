...
- [pi-pager](https://github.com/CymatiStatic/pi-pager) — Phone/watch push and two-way reply for Pi (and other coding agents) via ntfy.sh, with multi-instance routing and blocking approval exit codes
