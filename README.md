...
- [pi-mcp-tools](https://github.com/tickernelz/pi-mcp-tools) — Universal MCP (Model Context Protocol) tools extension for pi coding agent with local/remote server support
